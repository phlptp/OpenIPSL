within OpenIPSL.ElectricalFMU.Controls.PSSE.ES.SCRX;
model SCRX "Bus Fed or Solid Fed Static Exciter"
  ...
  OpenIPSL.NonElectrical.Logical.NegCurLogic negCurLogic(nstartvalue=efd0, RC_rfd=r_cr_fd) annotation (Placement(transformation(extent={{66,-22},{110,22}})));
